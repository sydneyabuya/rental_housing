<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('lease_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.leases.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/leases") || request()->is("admin/leases/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @can('workorder_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.workorders.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/workorders") || request()->is("admin/workorders/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
