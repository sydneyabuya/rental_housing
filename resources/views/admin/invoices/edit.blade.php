    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.invoices.update", [$invoice->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('billing_for') ? 'is-invalid' : '' }}" type="text" name="billing_for" id="billing_for" value="{{ old('billing_for', $invoice->billing_for) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('due') ? 'is-invalid' : '' }}" type="text" name="due" id="due" value="{{ old('due', $invoice->due) }}" required>
                @if($errors->has('due'))
                    <div class="invalid-feedback">
                        {{ $errors->first('due') }}
                    </div>
