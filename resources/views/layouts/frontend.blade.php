                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('property_access')
                                        <a class="dropdown-item" href="{{ route('frontend.properties.index') }}">
                                    ...
                                    @endcan
                                    @can('lease_access')
                                        <a class="dropdown-item" href="{{ route('frontend.leases.index') }}">
                                            {{ trans('cruds.lease.title') }}
                                        </a>
                                    @endcan
                                    @can('maintenance_access')
                                        <a class="dropdown-item" href="{{ route('frontend.maintenances.index') }}">
                                            {{ trans('cruds.maintenance.title') }}
                                        </a>
                                    @endcan
                                    @can('workorder_access')
                                        <a class="dropdown-item" href="{{ route('frontend.workorders.index') }}">
