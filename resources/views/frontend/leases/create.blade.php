    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.leases.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="paid" id="paid" value="{{ old('paid', '') }}" step="0.01">
                            @if($errors->has('paid'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('paid') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="paid_at" id="paid_at" value="{{ old('paid_at') }}">
